...
class AboutActivity : BaseAppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val aboutPage = AboutPage(this)
                ...
                .addWebsite(res string R.string.xplore_website, res string R.string.about_website)
                .addFacebook(res string R.string.xplore_facebook, res string R.string.about_facebook)
                .addInstagram(res string R.string.xplore_instagram, res string R.string.about_instagram)
