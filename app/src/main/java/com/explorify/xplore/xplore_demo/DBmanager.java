...
public class DBmanager extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.explorify.xplore.xplore_demo/databases/"+DB_NAME;
...
//    default database path (so other classes can later read it)
    ...
    public Drawable getReserveImage(String table, int id, Context context)
    {
        ...
        int tempImageId = resources.getIdentifier(getStrFromDB(table, id, getImageColumnName()),"drawable","com.explorify.xplore.xplore_demo");
